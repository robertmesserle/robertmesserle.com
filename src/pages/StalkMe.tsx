...
const StalkMe: React.FC = memo(() => {
  return (
    <Page header="stalk me" subheader="on social media">
      <Section centered>
        <p>
          I am highly stalkable through various forms of social media, so stalk
          away!
        </p>
      </Section>
      <ContentWrapper>
        <List title="Personal">
          <ListItem
            href="http://facebook.com/robert.messerle"
            icon="facebook"
            title="Facebook"
          />
          <ListItem
            href="http://twitter.com/Bobbo_O"
            icon="twitter"
            title="Twitter"
          />
          <ListItem
            href="http://steamcommunity.com/id/domifer/"
            icon="steam"
            title="Steam"
          />
          <ListItem
        ...
        <List title="Professional">
          <ListItem
            href="https://github.com/robertmesserle"
            icon="github"
            title="Github"
          />
          <ListItem
            href="https://codepen.io/robertmesserle"
            icon="codepen"
            title="CodePen"
          />
          <ListItem
...
const List = memo(({ children, title }: ListProps) => (
  <ListWrapper>
    <h1>{title}</h1>
    <div>{children}</div>
  </ListWrapper>
...
const ListItem = memo(({ href, icon, title }: ListItemProps) => (
